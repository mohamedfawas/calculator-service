...
func (c *calculatorClient) Subtract(ctx context.Context, in *CalculateRequest, opts ...grpc.CallOption) (*CalculateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CalculateResponse)
...
func (UnimplementedCalculatorServer) Subtract(context.Context, *CalculateRequest) (*CalculateResponse, error) {
...
func _Calculator_Subtract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Subtract(ctx, req.(*CalculateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
